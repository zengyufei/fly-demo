package com.zyf.common.二维码生成工具类;
...
public class QRCodeUtil {
     ...
     * 解析二维码
     * @param path 二维码图片地址
     * @return 不是二维码的内容返回 null, 是二维码直接返回识别的结果
     * @throws Exception
     */
...
//        com.zyf.test.二维码生成.QRCodeUtil.encode(text, imagePath, destPath, true);
        // 验证图片是否含有二维码  
